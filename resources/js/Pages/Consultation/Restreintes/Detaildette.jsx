...
export default function Detaildette({ results, title, type, searchParams }) {
    ...
    useEffect(() => {
        ...
        const debounce = setTimeout(() => {
            router.get(route('dette.details', { type }), {
                search: searchValue,
    ...
    const handlePerPageChange = (value) => {
        router.get(route('dette.details', { type }), { ...searchParams, search: searchValue, per_page: value }, { preserveState: true, preserveScroll: true });
    };
